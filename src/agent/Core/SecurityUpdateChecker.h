...
#ifdef TEST_SERVER
//#define CHECK_HOST_DEFAULT "securitycheck.phusionpassenger.dev"
#define CHECK_URL_DEFAULT "https://" CHECK_HOST_DEFAULT ":3000/v1/check.json"
#define MIN_CHECK_BACKOFF_SEC 10
#else
...
#ifdef TEST_SERVER
		this->checkIntervalSec = MIN_CHECK_BACKOFF_SEC;
#endif
...
#ifdef TEST_SERVER
			string localApprovedCert = "/home/onix/security_update_check_test/ca.crt";
			if (!verifyFileReadable((char *) localApprovedCert.c_str())) {
				logUpdateFail("File not readable: " + localApprovedCert);
				break;
			}
...
#ifdef TEST_SERVER
			P_NOTICE(responseDataJson.toStyledString());
#endif
